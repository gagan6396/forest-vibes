...
const rooms: Room[] = [
  ...
  },
  {
    ...
    longDescription: "The Lily Room stands as a testament to uncompromising luxury and attention to detail. This sprawling 4-bedroom suite spans an impressive 120 square meters and can comfortably accommodate up to 8 guests in absolute opulence. Each bedroom is a sanctuary of peace, featuring custom-crafted emperor-sized beds, premium hypoallergenic bedding, and ambient lighting that can be adjusted to suit your mood. The attached bathrooms are reminiscent of Roman spas, complete with deep soaking tubs, rainfall showers, heated floors, and a curated selection of aromatic toiletries. Step onto your private balcony and be greeted by panoramic views that stretch to the horizon. The room also features a private dining area, a fully equipped gourmet kitchen, a dedicated entertainment zone with a 75-inch 4K television, and a private terrace perfect for morning yoga or evening cocktails. At the Lily Room, every moment is designed to be extraordinary, from the champagne welcome to the personalized turndown service.",
    price: 11000,
    size: "120 m²",
    rating: 5.0,
    reviews: 42,
  ...
  },
  {
    ...
    longDescription: "The Daisy Room stands as a testament to uncompromising luxury and attention to detail. This sprawling 4-bedroom suite spans an impressive 120 square meters and can comfortably accommodate up to 8 guests in absolute opulence. Each bedroom is a sanctuary of peace, featuring custom-crafted emperor-sized beds, premium hypoallergenic bedding, and ambient lighting that can be adjusted to suit your mood. The attached bathrooms are reminiscent of Roman spas, complete with deep soaking tubs, rainfall showers, heated floors, and a curated selection of aromatic toiletries. Step onto your private balcony and be greeted by panoramic views that stretch to the horizon. The room also features a private dining area, a fully equipped gourmet kitchen, a dedicated entertainment zone with a 75-inch 4K television, and a private terrace perfect for morning yoga or evening cocktails. At the Daisy Room, every moment is designed to be extraordinary, from the champagne welcome to the personalized turndown service.",
    price: 11000,
    size: "120 m²",
    rating: 5.0,
    reviews: 42,
