  ...
  return (
    <>
      <style>{`
        ...
        /* Single banner that works on all devices */
        .banner-bg {
        ...
        /* Optimize for mobile - same image, just different positioning */
      ...
      <div className="about-section bg-[#f5f0e8]">
        ...
        {/* ══════════════════════════════════════
            1. FULL-WIDTH CINEMATIC BANNER - Optimized for all devices
        ══════════════════════════════════════ */}
        <div className="relative w-full h-[70vh] sm:h-[80vh] md:h-[92vh] banner-bg">
          <div className="absolute inset-0 z-10 flex flex-col justify-end px-6 sm:px-10 md:px-16 lg:px-[72px] pb-12 sm:pb-16 md:pb-20">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
              <p className="text-[#c9d8cc] text-[12px] sm:text-[13px] leading-[1.75] font-[300] max-w-[400px]"
        ...
        <div ref={s1.ref} className="relative grain overflow-hidden bg-[#f5f0e8]">
          <div className="relative z-[2] grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
            ...
            {/* LEFT — text */}
            <div className="flex flex-col justify-center px-6 sm:px-10 md:px-16 lg:px-[72px] py-16 sm:py-20 lg:py-28">
              ...
              <h2
                className={`rv d1 ${s1.inView ? "on" : ""} mb-6 sm:mb-8`}
                style={{
                  fontFamily: "'Playfair Display', serif",
              ...
              <div className={`rv d2 ${s1.inView ? "on" : ""} flex flex-col gap-4 sm:gap-5 mb-10 sm:mb-12`}>
                <p className="text-black text-base sm:text-xl font-[300] leading-[1.85]">
              ...
              {/* stats row */}
              <div className={`rv d3 ${s1.inView ? "on" : ""} flex flex-wrap gap-x-6 sm:gap-x-10 gap-y-5 sm:gap-y-7 border-t border-[#2d5a3d]/[0.12] pt-6 sm:pt-10`}>
                {[
                  { n: "48", l: "Properties" },
                  { n: "19", l: "Destinations" },
                  { n: "12K+", l: "Stays" },
                  ...
                  <div key={s.n} className="flex flex-col gap-1">
                    ...
                    <span className="text-[#a09888] text-[10px] sm:text-[11px] font-[300] tracking-[0.06em]">{s.l}</span>
                  </div>
                ))}
              </div>
            </div>
