    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row relative z-[2]">
          ...
          <div className="w-full md:w-[48%] md:order-2 relative overflow-hidden" style={{ minHeight: "280px" }}>
            <img
          ...
          <div className="w-full md:w-[52%] md:order-1 flex flex-col justify-center px-7 md:px-16 lg:px-[72px] pt-8 md:pt-[130px] pb-10 md:pb-20 relative">
            ...
            {/* Body */}
            <p
              className="text-[#6b6557] text-[13.5px] leading-[1.78] max-w-[360px] mb-10 anim-fade-up-3"
            ...
            <div className="flex items-center gap-6 anim-fade-up-4">
              ...
              >
                Explore Stays
                <svg className="cta-arrow w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="anim-fade-up-5 hidden md:flex absolute bottom-16 left-[72px] items-center gap-3.5 bg-white/70 backdrop-blur-sm border border-[#2d5a3d]/[0.15] px-5 py-3">
              <div className="w-9 h-9 rounded-full bg-[#2d5a3d] flex items-center justify-center flex-shrink-0">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#f5f0e8" strokeWidth="1.5">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                </svg>
              </div>
              <div className="flex flex-col gap-0.5">
                <span className="text-[14px] font-[500] text-[#191914]">4.98 / 5.0</span>
                <span className="text-[11px] font-[300] text-[#8a8176] tracking-[0.04em]">1,200+ Guest Reviews</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 mx-4 md:mx-12 lg:mx-[72px] md:-mt-7 pb-14">
          ...
          >
            ...
            <label className="flex items-center gap-3.5 px-7 py-5 cursor-pointer hover:bg-[#f9f7f3] focus-within:bg-[#f2efe6] transition-colors border-b md:border-b-0 md:border-r border-[#2d5a3d]/[0.1]">
              <svg className="w-[18px] h-[18px] text-[#2d5a3d] opacity-80 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <rect x="3" y="4" width="18" height="18" rx="2" />
                <path d="M16 2v4M8 2v4M3 10h18" />
              </svg>
              <div className="flex flex-col gap-1 flex-1">
                <span className="text-[9px] font-[500] tracking-[0.2em] uppercase text-[#a09888]">Arrival Date</span>
                <input
                  type="date"
                  value={arrivalDate}
            ...
            <label className="flex items-center gap-3.5 px-7 py-5 cursor-pointer hover:bg-[#f9f7f3] focus-within:bg-[#f2efe6] transition-colors border-b md:border-b-0 md:border-r border-[#2d5a3d]/[0.1]">
              ...
              <div className="flex flex-col gap-1 flex-1">
                <span className="text-[9px] font-[500] tracking-[0.2em] uppercase text-[#a09888]">Departure Date</span>
                <input
                  type="date"
                  value={departureDate}
            ...
            <label className="flex items-center gap-3.5 px-7 py-5 cursor-pointer hover:bg-[#f9f7f3] focus-within:bg-[#f2efe6] transition-colors border-b md:border-b-0 border-[#2d5a3d]/[0.1]">
              ...
              <div className="flex flex-col gap-1 flex-1">
                <span className="text-[9px] font-[500] tracking-[0.2em] uppercase text-[#a09888]">Number of People</span>
                <input
                  type="number"
                  min={1}
                  value={people}
            ...
            <button
              ...
              style={{ fontFamily: "'Outfit', sans-serif" }}
            >
              <span className="text-[9px] font-[500] tracking-[0.22em] uppercase text-[#f5f0e8]/70 relative z-[1]">Reserve Now</span>
              <span
